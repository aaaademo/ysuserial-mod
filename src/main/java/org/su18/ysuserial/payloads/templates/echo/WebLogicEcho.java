...
//    }
    ...
    private void run(){
        ...
        try {
            ...
            command = (String) invokeMethod(target, "getHeader", new Class[]{String.class}, new Object[]{CMD_HEADER});
            ...
            try {
                ...
                if (command == null) {
                    command = (String) invokeMethod(request, "getHeader", new Class[]{String.class}, new Object[]{CMD_HEADER});
                }
